...
/**
 * Tests cyclic encode with lower case string that include
 * special character and positive k=2.
 * @return 0 upon success.
 */
...
/**
 * Tests cyclic decode with lower case string that include
 * special character and positive k=2.
 * @return 0 upon success.
 */
...
/**
 * Tests non-cyclic decode with lower case string that include special
 * character and negative k=-1.
 * @return 0 upon success.
 */
